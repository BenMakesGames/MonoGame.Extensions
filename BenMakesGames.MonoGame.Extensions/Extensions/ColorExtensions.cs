...
namespace BenMakesGames.MonoGame.Extensions.Extensions;

public static class ColorExtensions
{
    /// <summary>
    /// Given a color, palette of colors, and a function which computes the distance between two colors,
    /// this method returns the color from the palette which is closest to the given color.
    /// </summary>
    /// <param name="color"></param>
    /// <param name="palette"></param>
    /// <param name="distanceFunction"></param>
    /// <returns>The color from the palette which is closest to the given `color`.</returns>
    /// <exception cref="ArgumentException">Thrown when `palette` is empty.</exception>
    ...
    /// <returns>The minimum and maximum R G B values found among the given `colors`.</returns>
